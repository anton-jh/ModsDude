...
namespace ModsDude.Server.Persistence.Migrations
{
    ...
    [Migration("20260910174407_SavegameProfileBinding")]
    partial class SavegameProfileBinding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Savegames.SavegameVersion", b =>
                {
                    ...
                    b.ToTable("SavegameVersions", t =>
                        {
                            t.HasCheckConstraint("CK_SavegameVersions_ProfileAndRevisionAreSetTogether", "(\"ProfileId\" IS NULL) = (\"ProfileRevision\" IS NULL)");
                        });
                });
