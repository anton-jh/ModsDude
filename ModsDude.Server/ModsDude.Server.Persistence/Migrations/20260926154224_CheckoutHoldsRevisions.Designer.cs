...
namespace ModsDude.Server.Persistence.Migrations
{
    ...
    [Migration("20260926154224_CheckoutHoldsRevisions")]
    partial class CheckoutHoldsRevisions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Activity.GameActivity", b =>
                {
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.ModHub.ModHubCrawlState", b =>
                {
                    b.Property<string>("Game")
                        .HasColumnType("text");

                    b.PrimitiveCollection<List<int>>("HeadModIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.Property<DateTimeOffset?>("SweepCompletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("SweepNextPage")
                        .HasColumnType("integer");

                    b.HasKey("Game");

                    b.ToTable("ModHubCrawlStates");
                });

            modelBuilder.Entity("ModsDude.Server.Domain.ModHub.ModHubMod", b =>
                {
                    b.Property<string>("Game")
                        .HasColumnType("text");

                    b.Property<int>("ModHubId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Game", "ModHubId");

                    b.HasIndex("Game", "FetchedAt");

                    b.HasIndex("Game", "FileNameKey");

                    b.ToTable("ModHubMods");
                });
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Mods.ModVersion", b =>
                {
                    ...
                    b.Property<DateOnly?>("DeletionScheduledFor")
                        .HasColumnType("date");
                    ...
                    b.ToTable("ModVersions", t =>
                        {
                            t.HasCheckConstraint("CK_ModVersions_DeletionIsScheduledWithAReason", "(\"DeletionScheduledFor\" IS NULL) = (\"DeletionReason\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Profiles.ProfileIgnoredMod", b =>
                {
                    b.Property<Guid>("RepoId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("RepoId", "ProfileId", "ModId");

                    b.ToTable("ProfileIgnoredMods");
                });
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Profiles.ProfileRevision", b =>
                {
                    ...
                    b.ToTable("ProfileRevisions", t =>
                        {
                            t.HasCheckConstraint("CK_ProfileRevisions_DeletionIsScheduledWithAReason", "(\"DeletionScheduledFor\" IS NULL) = (\"DeletionReason\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Savegames.SavegameCheckout", b =>
                {
                    ...
                    b.Property<int?>("HoldsFromRevision")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Savegames.SavegameSnapshot", b =>
                {
                    b.Property<Guid>("RepoId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SavegameSnapshots", t =>
                        {
                            t.HasCheckConstraint("CK_SavegameSnapshots_DeletionIsScheduledWithAReason", "(\"DeletionScheduledFor\" IS NULL) = (\"DeletionReason\" IS NULL)");

                            t.HasCheckConstraint("CK_SavegameSnapshots_ProfileAndRevisionAreSetTogether", "(\"ProfileId\" IS NULL) = (\"ProfileRevision\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ModsDude.Server.Domain.Savegames.SavegameSnapshot", b =>
                {
                    ...
                    b.OwnsMany("ModsDude.Server.Domain.Savegames.SavegameDetail", "Details", b1 =>
                        {
                            b1.Property<Guid>("SavegameSnapshotRepoId")
                                .HasColumnType("uuid");

                            b1.Property<Guid>("SavegameSnapshotSavegameId")
                                .HasColumnType("uuid");

                            b1.Property<int>("SavegameSnapshotNumber")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("SavegameSnapshotRepoId", "SavegameSnapshotSavegameId", "SavegameSnapshotNumber", "Id");

                            b1.ToTable("SavegameSnapshotDetails", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("SavegameSnapshotRepoId", "SavegameSnapshotSavegameId", "SavegameSnapshotNumber");
                        });
