...
| --- | --- |
| [01 — Overview](01-overview.md) | What ModsDude is, the mental model, and the client/server split that decides where work goes |
...
| [10 — Savegames and profile revisions](10-savegame-profile-binding.md) | One current savegame per profile, how a version learns which revision it was played on, and which folder a slot is in |
